      ...
      <div className="max-w-xl w-full text-center space-y-8">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-3 text-lg text-gray-400 leading-relaxed">
              AI-powered training that adapts to your Strava data
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
          <div className="bg-[#1a1a1a] rounded-xl p-4 border border-white/5">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              15-week program built around your current fitness and goal pace
            </p>
          </div>
          <div className="bg-[#1a1a1a] rounded-xl p-4 border border-white/5">
            <div className="text-orange-400 text-sm font-semibold mb-1">Strava Sync</div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your runs are automatically logged and your plan adapts in real time
            </p>
          </div>
          <div className="bg-[#1a1a1a] rounded-xl p-4 border border-white/5">
            <div className="text-orange-400 text-sm font-semibold mb-1">Coach Notes</div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Every session has AI-generated guidance so you train smarter
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-gray-600">
            We only read your running activities — we never post on your behalf
          </p>
        </div>
      </div>
    </main>
